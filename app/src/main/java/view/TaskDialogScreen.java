...
public class TaskDialogScreen extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabelNomeObrigatorio.setForeground(java.awt.Color.red);
        ...
        jLabelPrazoObrigatorio.setForeground(java.awt.Color.red);
        ...
        jPanelTaskLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelTaskLayout.createSequentialGroup()
                ...
                .addGroup(jPanelTaskLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jLabelPrazoObrigatorio, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanelTaskLayout.setVerticalGroup(
            ...
            .addGroup(jPanelTaskLayout.createSequentialGroup()
                ...
                .addGap(4, 4, 4)
                .addComponent(jLabelPrazoObrigatorio)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jLabelToolBarSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelToolBarSaveMouseClicked
        ...
        if (isUpdate != true) {
            try {
                if (isFieldsValid()) {
                    Task task = new Task();
                    task.setIdProject(project.getIdProjeto());
    ...
    public boolean isFieldsValid(){
        return (!jTextFieldName.getText().isEmpty()) && (!jFormattedTextFieldDeadline.
                getText().isEmpty());
    }
